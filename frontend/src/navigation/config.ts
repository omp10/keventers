  ...
  groups: [
    {
      items: [
        ...
        { key: 'feedback', label: 'Feedback & NPS', icon: 'star', path: '/dashboard/feedback', access: { anyPermission: ['customer:read', 'analytics:read'] } },
  ...
  groups: [
    ...
    },
    {
      ...
      items: [
        ...
        { key: 'admin-loyalty', label: 'Loyalty rule', icon: 'star', path: '/admin/loyalty', access: { anyRole: ['super_admin'] } },
