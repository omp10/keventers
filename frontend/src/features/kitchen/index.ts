 ...
 */
export { KitchenShell, KitchenBoardRoute, KitchenDashboardRoute, KitchenOrdersRoute, KitchenStationsRoute, KitchenTablesRoute, KitchenStaffRoute, KitchenHistoryRoute, KitchenMenuRoute, KitchenProfileRoute } from './routes';
