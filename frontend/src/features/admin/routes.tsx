...
export const adminRoutes: AdminRoute[] = [
  { path: '/admin', element: <Dashboard /> }, { path: '/admin/organizations', element: <Organizations /> }, { path: '/admin/approvals', element: <Approvals /> }, { path: '/admin/onboarding-fields', element: <OnboardingFields /> }, { path: '/admin/restaurants', element: <Organizations /> }, { path: '/admin/users', element: <Users /> }, { path: '/admin/payments', element: <Payments /> }, { path: '/admin/analytics', element: <Analytics /> }, { path: '/admin/notifications', element: <Notifications /> }, { path: '/admin/flags', element: <Flags /> }, { path: '/admin/audit', element: <Audit /> }, { path: '/admin/monitoring', element: <Monitoring /> }, { path: '/admin/settings', element: <Settings /> },
];
